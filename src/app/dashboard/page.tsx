        ...
        <div className="dashboard-layout animate-pro">
            ...
            <main className="main-content">
                <div className="top-bar">
                    ...
                    >
                        <span className="visitor-guide-btn-ring" aria-hidden="true">
                            <BookOpen size={18} strokeWidth={2.4} />
                        </span>
                        <span className="visitor-guide-btn-copy">
                            <span className="visitor-guide-btn-label">Hagaha &amp; Tilmaamaha</span>
                            <span className="visitor-guide-btn-hint">Ma taqaan sida loo isticmaalo?</span>
                        </span>
                    </button>
            ...
            <style jsx>{`
                ...
                .visitor-guide-btn-copy { display: flex; flex-direction: column; align-items: flex-start; gap: 2px; text-align: left; }
                .visitor-guide-btn-label { font-size: 0.78rem; font-weight: 800; color: #1e40af; line-height: 1.2; }
                .visitor-guide-btn-hint { font-size: 0.62rem; font-weight: 700; color: #64748b; line-height: 1; }
                ...
                :global(html.dark) .visitor-guide-btn-label { color: #93c5fd; }
                :global(html.dark) .visitor-guide-btn-hint { color: #94a3b8; }
                ...
                @media (max-width: 1100px) {
                    ...
                    .visitor-guide-btn { padding: 10px 14px; order: 3; width: 100%; justify-content: center; }
                    .visitor-guide-btn-copy { align-items: center; text-align: center; }
